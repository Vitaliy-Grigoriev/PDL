...
const x3::rule<LiteralRuleId, syntax::literals::PlaceholderLiteral>   placeholderLiteral   {"Placeholder Literal"};
...
const x3::rule<LiteralRuleId, syntax::literals::BooleanLiteral>       booleanLiteral       {"Boolean Literal"};
